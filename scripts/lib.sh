...
legislate() {
  ...
  PRESIDENT_MSG=$(echo -e \
    ...
    " 1) to discard the ${SECRET_POLICIES[0]} and pass ${SECRET_POLICIES[1]}-${SECRET_POLICIES[2]} to Chancellor $PUBLIC_CHANCELLOR_NAME." \
    " 2) to discard the ${SECRET_POLICIES[1]} and pass ${SECRET_POLICIES[0]}-${SECRET_POLICIES[2]} to Chancellor $PUBLIC_CHANCELLOR_NAME." \
    " 3) to discard the ${SECRET_POLICIES[2]} and pass ${SECRET_POLICIES[0]}-${SECRET_POLICIES[1]} to Chancellor $PUBLIC_CHANCELLOR_NAME." \
  )
  ...
  #await_sms_reply_from "$PUBLIC_PRESIDENT_PHONE"
