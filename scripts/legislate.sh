...
legislate() {
  ...
  PUBLIC_PRESIDENT_PHONE=`lookup "$PUBLIC_PLAYER_PHONES" "$PUBLIC_PRESIDENT_NAME" 2`
  PUBLIC_PRESIDENT_TITLE=`lookup "$PUBLIC_PLAYER_TITLES" "$PUBLIC_PRESIDENT_NAME" 3`
  PUBLIC_CHANCELLOR_PHONE=`lookup "$PUBLIC_PLAYER_PHONES" "$PUBLIC_CHANCELLOR_NAME" 2`
  PUBLIC_CHANCELLOR_TITLE=`lookup "$PUBLIC_PLAYER_TITLE" "$PUBLIC_CHANCELLOR_NAME" 3`
